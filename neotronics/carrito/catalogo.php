<?php  
    ...
    include_once($_SERVER["DOCUMENT_ROOT"]."/acceso_db.php");
...
<?php 
	//mostramos todos nuestros artículos, viendo si han sido agregados o no a nuestro 
	//carro de compra 
...
<tr valign="middle" class="catalogo">  
	...
	<td align="center"> 
<?php 
	if(!$carro || !isset($carro[md5($row['id_proyecto'])]['identificador']) || $carro[md5($row['id_proyecto'])]['identificador']!=md5($row['id_proyecto'])){ 
...
?> 
	<a href="<?php echo $carrito?>agregacar.php?<?php echo SID ?>&id=<?php echo $row['id_proyecto']; ?>"> 
	<img src="productonoagregado.gif" border="0" title="Agregar al Carrito"></a><?php }else 
	//en caso contrario mostramos la otra imagen linkeada., a la página que sirve para borrar el 
	//artículo del carro. 
